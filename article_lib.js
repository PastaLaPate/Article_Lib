...
function addImageToArticle(
	...
	if(div_class != undefined) {
		img_container.setAttribute("class", div_class);
	}
	if(div_id != undefined) {
		img_container.setAttribute("id", div_id);
	}
...
function addButtonToArticle(
	...
	if(button_text_class != undefined) {
		button.setAttribute("class", button_text_class);
	}
	if(button_text_id != undefined) {
		button.setAttribute("id", button_text_id);
	}
	if(button_container_class != undefined) {
		button_container.setAttribute("class", button_container_class);
	}
	if(button_container_id != undefined) {
		button_container.setAttribute("id", button_container_id);
	}
